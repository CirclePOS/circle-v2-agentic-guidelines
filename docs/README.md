...
│   └── SETUP.md                 ← Legacy setup info
├── CLAUDE.md                    ← Project configuration
│
├── runtime/
│   ├── agents/                  ← Specialized agents
│   │   ├── AGENT-TEAM.md        ← Team structure & hand-offs
│   │   ├── backend-dev-agent.md ← Rails development
│   │   ├── frontend-dev-agent.md← Hotwire + Vue 3 (legacy)
│   │   ├── tester-agent.md      ← Test strategy & QA
│   │   ├── backend-pm-agent.md  ← Backend PM (complex work)
│   │   ├── frontend-pm-agent.md ← Frontend PM (complex work)
│   │   ├── github-agent.md      ← Epic/issue tracking
│   │   ├── flaky-test-resolver-agent.md ← Flaky test specialist
│   │   └── tmux-orchestration.md← tmux layout conventions
│   │
...
- **`backend-dev-agent`** — Rails models, commands, services, APIs
- **`frontend-dev-agent`** — Hotwire (primary), Vue 3 (maintenance)
- **`tester-agent`** — RSpec/Cypress strategy, failure triage
- **`backend-pm-agent`** — Backend PM for complex multi-story work
- **`frontend-pm-agent`** — Frontend PM for complex multi-story work
...
```
backend-dev-agent: "This needs a Vue component. Handing to frontend-dev-agent."
frontend-dev-agent: "API call failing. Handing to backend-dev-agent."
tester-agent: "New test failure. Escalating to backend-dev-agent."
```
